...
parser.add_argument('--ylim' , help='Limits of y-axis', default="")
parser.add_argument('--domain' , help='String for the x-range given as \"star,end\" ', default="")
parser.add_argument("--mev", default=False, action="store_true" , help="Convert from Ry to meV")
parser.add_argument("--mevlabel", default=False, action="store_true" , help="Use labels in meV")
parser.add_argument("--ev", default=False, action="store_true" , help="Convert from Ry to eV")
parser.add_argument("--evlabel", default=False, action="store_true" , help="Use labels in eV")
...
parser.add_argument("--gap", default=0.0, type=float, help='Mark gap around Ef (must be given in the same units as the axis)')
...
parser.add_argument("--centeref", default=False, action="store_true" , help="Shift energy reference to Ef=0")
