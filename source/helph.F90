...
subroutine helphbccsoc(kp,h00so,h01so,h10so,mm)
	use mod_f90_kind
	use mod_constants
	use mod_lattice
...
subroutine helphfccsoc(kp,h00so,h01so,h10so,h02so,h20so,mm)
	use mod_f90_kind
	use mod_constants
	use mod_lattice
	use mod_tight_binding
