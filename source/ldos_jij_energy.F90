...
!$omp& shared(prog,spiner,elapsed_time,start_program,progbar,kbz,nkpoints,wkbz,e,eta,Npl,hdel,mz,nmaglayers,mmlayermag,pauli,paulimatan,ldosu,ldosd,Jijint,nthreads,outputunit_loop)
