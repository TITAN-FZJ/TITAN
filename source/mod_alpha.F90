...
contains
  ...
  subroutine write_alpha(e)
    ...
    do i = 1, s%nAtoms
      ...
      alpha_v4 =   gammaM * aimag(m_chi_hf(sigmai2i(1,i),sigmai2i(1,i))) / e * s%Basis(i)%Um**2
      ...
      write(55 + 4*s%nAtoms+i,"(8(es16.9,2x))") e, gammaM, real(m_chi_hf_inv(sigmai2i(1,i),sigmai2i(1,i)))**2, s%Basis(i)%Um**2, alpha_v1, alpha_v2, alpha_v3, alpha_v4
