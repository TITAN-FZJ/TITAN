! Integration of Green functions over k vectors to calculate the jacobian of self-consistency system
subroutine sumk_scjac(er,ei,ggr)
  use mod_f90_kind
  use mod_constants
  use mod_parameters
